...
class TrackerFeaturizer:
    ...
    @staticmethod
    def _create_states(tracker: DialogueStateTracker, domain: Domain, omit_unset_slots: bool = False,) -> List[State]:
    ...
    def training_states_actions_and_entities(
        self, trackers: List[DialogueStateTracker], domain: Domain, omit_unset_slots: bool = False,
    ...
    def training_states_and_actions(
        ...
        (
            ...
            trackers_as_actions,
            _,
        ) = self.training_states_actions_and_entities(trackers, domain, omit_unset_slots=omit_unset_slots)
...
class FullDialogueTrackerFeaturizer(TrackerFeaturizer):
    ...
    def training_states_actions_and_entities(
        ...
        for tracker in pbar:
            states = self._create_states(tracker, domain, omit_unset_slots=omit_unset_slots)
